#!/usr/bin/env Python
#思路： COrr(findrank(decaylinear(delay(Z,5)/Z,3),15),findRank(decaylinear(delay(X+Y,3)/(X+Y),3),15))
# -*- coding:utf-8 -*-
# author: gejf
...
class Factor(FactorBase):
    ...
    def __init__(self):
        ...
        self.needFields = [t.ADJCLOSE,t.ADJHIGH,t.ADJCLOSE]  # 设置需要的字段
    ...
    def factor_definition(self):
        ...
        adjX = needData[t.ADJCLOSE]
        adjY = needData[t.ADJHIGH]
        adjZ = needData[t.ADJCLOSE]
